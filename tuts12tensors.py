# PyTorch: Tensors
# Tensors are specialized data structure that are very similar to arrays and matrices.
# In PyTorch, we use tensors to encode the inputs and outputs of a model, as well as the model's parameters.
# Tensors are similar to NumPy's ndarrays, except that tensors can run GPUs or other specialized hardware to accelerate computing.
...
# The shape is a tuple of tensor dimensions.
...
# linear algebra, random sampling, and more are comprehensively described at:
...
# This computes the matrix multiplication between two sensor.
...
# In-place operations save memory, but cause problems when computing derivatives
...
# Bridge with NumPy
# Tensors on the CPU and NumPy array can share their underlying memory locations,
